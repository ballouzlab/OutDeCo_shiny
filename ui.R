            ...
            tabPanel(
              ...
              navlistPanel(
                ...
                tabPanel(title="Cluster Genes",
                  ...
                  h5("Options"),
                  p("In this example, we are assessing a gene list. For Assessing DE Data, there will be more options to choose from. Options for visualisation of clustering include: Network, Heatmap and Binarized Heatmap."), 
                  img(src="dropdown_CG.jpg", height = 150),
                  br(), 
                  br(), 
                  ...
                  tags$li("Binarized Heatmap"),
                  br(), 
                  tags$div("2) Select the plots you want to view by checking the checkbox associated with it.", p(""), "3) Click ", img(src="run_button.jpg", height = 30)),
                  br(), 
                  h4("Plots"),
                  h5("Heatmap"),  
                  ...
                  img(src="heatmap_of_genes_CG.jpg", height = 300),
                  h5("Network"),  
                  ...
                  img(src="network_of_genes_CG.jpg", height = 300),
                  ...
                  img(src="binarized_heatmap_CG.jpg", height = 300),
                  br(), 
                  h4("Tables"), 
                  ...
                  img(src="gene_deetz_clustering.jpg", height = 500), 
                ...
                tabPanel(title="Gene Connectivity",
                  ...
                  tags$div("1) Select the",  img(src="options.jpg", height = 30), "dropdown"),
                  h5("Options"),
                  p("In this example, we are assessing a gene list. For Assessing DE Data, there will be more options to choose from. Options for visualisation of gene connectivity include: Density, Clustered Density,  Histogram. When any histogram is chosen, a slider appears for the user to change the number of breaks in the histogram."), 
                  img(src="dropdown_GC.jpg", height = 250),
                  br(), 
                  br(), 
                  p("For Assessing DE Data, the user has the following options"),
                  h6(strong("Upregulated")), 
                  ...
                  img(src="plot_scatter_density_up.png", height = 300), 
                  h5("Histogram"),
                  p("Histogram of gene connectivity."),
                  img(src="plot_scatter_hist_up.png", height = 300),
                  h5("Subset by clusters"),  
                  p("Gene connectivity can be subset by their clusters as well."),
                  img(src="plot_scatter_hist_down_colored.png", height = 300), 
                  br(),
                  # em("Note: This tool is under construction"),
                ...
                tabPanel(title="Functional Outliers",
                  ...
                  tags$div("1) Select the",  img(src="options.jpg", height = 30), "dropdown"),
                  h5("Options"),
                  p("In this example, we are assessing a gene list. For Assessing DE Data, there will be more options to choose from. Options for visualising functional outliers include: Network, Heatmap, Genes in Modules and Functional Outliers. A slider will also appear, giving the user the option of choosing how many genes are required to form a module (default = 6)."),
                  img(src="dropdown_FO.jpg", height = 250),
                  br(), 
                  br(), 
                  p("For Assessing DE Data, the user has the following options"),
                  h6(strong("Select Plots")), 
                  tags$li("Upregulated Network"), 
                  tags$li("Upregulated Heatmap"), 
                  tags$li("Downregulated Network"),
                  tags$li("Downregulated Heatmap"),
                  h6(strong("Select Tables")),
                  tags$li("Upregulated Functional Outliers"), 
                  tags$li("Upregulated Genes in Module"), 
                  tags$li("Downregulated Functional Outliers"),
                  tags$li("Downregulated Genes in Module"),
                  br(),
                  tags$div("2) Select the plots you want to view by checking the checkbox associated with it.", p(""), "3) Click ", img(src="run_button.jpg", height = 30)),
                  br(),
                  h4("Plots"),
                  ...
                  img(src="plot_coexpression_heatmap_down_filt.png", height = 300),
                  h5("Network"),
                  p("Network plot detailing the outliers connectivity and expression."),
                  img(src="plot_network_down.png", height = 300),
                  br(),
                  br(),
                  h4("Tables"),
                  h5("Genes in Module"),
